							...
							<form action="RegistroCapacitacionServlet" method="post">
								...
								<div class="form-outline mb-4">
									<input type="text" id="form3Example3" class="form-control"
										...
										placeholder="Ingrese ID Capacitación" />
								</div>
								...
								<div class="form-outline mb-4">
									<input type="text" id="form3Example3" class="form-control"
										...
										placeholder="Ingrese el Día de la capacitación" />
								</div>
								...
								<div class="form-outline mb-4">
									<input type="text" id="form3Example3" class="form-control"
										...
										placeholder="Ingrese la Hora de la capacitación" />
								</div>
								...
								<div class="form-outline mb-4">
									<input type="text" id="form3Example3" class="form-control"
										...
										placeholder="Ingrese la Duración de la capacitación (En Minutos)" />
								</div>
